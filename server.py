...
<style>
*{{box-sizing:border-box}}body{{margin:0;font-family:Inter,'SF Pro Display',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;background:#f5f7fa;color:#1a1e2c;font-size:12px;line-height:1.35}}a{{color:#2563eb;text-decoration:none}}a:hover{{text-decoration:underline;color:#1d4ed8}}.wrap{{max-width:1500px;margin:0 auto;padding:8px;text-align:left}}header{{display:inline-flex;gap:2px;margin-bottom:6px;background:#fff;border-radius:10px;padding:4px 8px;box-shadow:0 1px 2px #0001;border:1px solid #e2e8f0}}.header-row{{display:flex;align-items:center;gap:4px;flex-wrap:wrap}}h1{{margin:0;font-size:18px;font-weight:700;letter-spacing:-.03em;color:#0f172a}}.server-meta{{display:flex;flex-wrap:wrap;gap:4px;margin-top:4px;background:#f1f5f9;border:1px solid #e2e8f0;border-radius:8px;padding:4px 10px;font-size:10px;color:#475569}}.server-meta span{{display:inline;gap:3px;font-size:10px;color:#475569;white-space:nowrap}}.muted{{color:#94a3b8}}h2{{margin:0 0 3px;font-size:13px;font-weight:700;color:#0f172a}}.topgrid{{display:block;margin-bottom:6px}}.stat,.panel{{background:#fff;border:1px solid #e2e8f0;border-radius:8px;padding:5px 8px;box-shadow:0 1px 2px #00000008;display:inline-block;vertical-align:top;margin-right:6px;width:auto;min-width:200px}}.stat span,.mini-stats span{{display:block;color:#64748b;font-size:9px;font-weight:500}}.stat b{{font-size:14px;color:#0f172a}}.panel{{margin-bottom:4px}}.mini-stats{{display:grid;grid-template-columns:repeat(5,minmax(60px,1fr));gap:3px;margin:3px 0 4px}}.mini-stats>div{{background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:3px 5px}}.mini-stats b{{font-size:12px;color:#0f172a}}table{{width:auto;border-collapse:separate;border-spacing:0;font-size:10px}}th,td{{text-align:left;border-bottom:1px solid #e2e8f0;padding:4px 5px;vertical-align:top;white-space:nowrap}}th{{color:#64748b;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.04em;background:#f8fafc;position:sticky;top:0;z-index:1}}td b{{display:block;font-weight:600}}td a{{font-weight:600}}.num{{text-align:center;font-weight:700;white-space:nowrap}}details summary{{cursor:pointer;color:#2563eb;font-weight:700;font-size:11px;margin-bottom:3px}}.tablebox{{display:inline-block;overflow:auto;border-radius:5px;border:1px solid #e2e8f0;background:#fff}}.unigrid{{display:grid;grid-template-columns:repeat(6,minmax(80px,1fr));gap:3px}}.unigrid>div{{background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:3px 5px}}.unigrid span{{display:block;color:#64748b;font-size:9px;font-weight:500}}.unigrid b{{font-size:12px;color:#0f172a}}@media(max-width:900px){{.topgrid,.mini-stats,.unigrid{{grid-template-columns:1fr 1fr}}table{{min-width:auto}}.wrap{{padding:4px}}}}
</style></head><body><div class="wrap">
<header><div class="header-row"><h1 style="margin:0;font-size:14px;white-space:nowrap">Дашборд всех проектов</h1><span style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;white-space:nowrap;font-size:9px">💾 <b>{esc(resources['memory']['free'])}</b> из {esc(resources['memory']['total'])}</span><span style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;white-space:nowrap;font-size:9px">💿 <b>{esc(resources['disk']['free'])}</b> из {esc(resources['disk']['total'])}</span><span style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;white-space:nowrap;font-size:9px">🇩🇪 Server1</span><span style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;white-space:nowrap;font-size:9px">📡 {esc(s['ip'])}</span><span style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;white-space:nowrap;font-size:9px">🟢 В работе</span><span style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;white-space:nowrap;font-size:9px">Действует до {esc(s['valid_until'])}</span><span style="background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;white-space:nowrap;font-size:9px">Обновлено {esc(s['generated'])}</span><details style="position:relative;display:inline-block"><summary style="cursor:pointer;background:#f1f5f9;border:1px solid #e2e8f0;border-radius:5px;padding:1px 6px;font-size:9px;color:#2563eb;font-weight:600">Cron</summary><div class="tablebox" style="position:absolute;top:100%;left:0;z-index:100;min-width:620px;max-width:90vw;box-shadow:0 4px 20px #0002;overflow-x:auto"><table><thead><tr><th>Профиль</th><th>Задача</th><th>Вкл</th><th>Расписание</th><th>Последний запуск</th><th>Следующий</th><th>Статус</th><th>Ошибка</th></tr></thead><tbody>{cron_html}</tbody></table></div></details></div></header>
