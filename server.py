...
<section class="panel"><h2>Cron всех проектов</h2><div class="tablebox"><table><thead><tr><th>Профиль</th><th>Задача</th><th>Вкл</th><th>Расписание</th><th>Последний запуск</th><th>Следующий</th><th>Статус</th><th>Ошибка</th></tr></thead><tbody>{cron_html}</tbody></table></div></section>
