...
<section class="panel"><details><summary style="cursor:pointer;color:#475569;font-weight:600;font-size:10px;padding:2px 0">Cron всех проектов</summary><div class="tablebox" style="margin-top:4px"><table><thead><tr><th>Профиль</th><th>Задача</th><th>Вкл</th><th>Расписание</th><th>Последний запуск</th><th>Следующий</th><th>Статус</th><th>Ошибка</th></tr></thead><tbody>{cron_html}</tbody></table></div></details></section>
