...
<style>
*{{box-sizing:border-box}}body{{margin:0;font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;background:#0b1020;color:#eef2ff;font-size:13px}}a{{color:#8bd3ff;text-decoration:none}}a:hover{{text-decoration:underline}}.wrap{{max-width:1500px;margin:0 auto;padding:14px}}header{{display:flex;justify-content:space-between;gap:12px;align-items:center;margin-bottom:10px}}h1{{margin:0;font-size:24px;letter-spacing:-.04em}}h2{{margin:0 0 8px;font-size:17px}}p{{margin:2px 0 0;color:#98a2b3}}.topgrid{{display:grid;grid-template-columns:repeat(2,minmax(220px,1fr));gap:10px;margin-bottom:10px}}.stat,.panel{{background:#111936;border:1px solid #26304f;border-radius:14px;padding:12px;box-shadow:0 8px 25px #0004}}.stat span,.mini-stats span{{display:block;color:#98a2b3;font-size:11px}}.stat b{{font-size:20px}}.panel{{margin-bottom:10px}}.mini-stats{{display:grid;grid-template-columns:repeat(5,minmax(120px,1fr));gap:8px;margin:8px 0 10px}}.mini-stats>div{{background:#0c132a;border:1px solid #222c49;border-radius:10px;padding:9px}}.mini-stats b{{font-size:17px}}table{{width:100%;border-collapse:separate;border-spacing:0;font-size:12px}}th,td{{text-align:left;border-bottom:1px solid #26304f;padding:8px;vertical-align:top}}th{{color:#98a2b3;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.04em;background:#111936}}td b{{display:block}}.num{{text-align:center;font-weight:900;white-space:nowrap}}.refresh{{background:#2563eb;color:white;border:0;border-radius:10px;padding:9px 12px;font-weight:800;cursor:pointer}}details summary{{cursor:pointer;color:#c8d4ff;font-weight:900;margin-bottom:8px}}.tablebox{{overflow:auto;border-radius:10px}}.unigrid{{display:grid;grid-template-columns:repeat(6,minmax(120px,1fr));gap:8px}}.unigrid>div{{background:#0c132a;border:1px solid #222c49;border-radius:10px;padding:9px}}.unigrid span{{display:block;color:#98a2b3;font-size:11px}}.unigrid b{{font-size:17px}}@media(max-width:900px){{.topgrid,.mini-stats,.unigrid{{grid-template-columns:1fr 1fr}}table{{min-width:820px}}.wrap{{padding:8px}}}}
