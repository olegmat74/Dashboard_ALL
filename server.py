...
<style>
*{{box-sizing:border-box}}body{{margin:0;font-family:'Inter','SF Pro',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#f0f2f5;color:#111827;font-size:16px;line-height:1.6}}a{{color:#2563eb;text-decoration:none}}a:hover{{text-decoration:underline;color:#1d4ed8}}.wrap{{max-width:1500px;margin:0 auto;padding:20px;text-align:left}}header{{display:inline-flex;gap:4px;margin-bottom:14px;background:#fff;border-radius:14px;padding:10px 18px;box-shadow:0 1px 4px #0000000a;border:1px solid #e2e8f0}}.header-row{{display:flex;align-items:center;gap:10px;flex-wrap:wrap}}h1{{margin:0;font-size:26px;font-weight:700;letter-spacing:-.03em;color:#0f172a}}.muted{{color:#94a3b8}}h2{{margin:0 0 8px;font-size:17px;font-weight:700;color:#0f172a;display:flex;align-items:center;gap:6px}}.stat,.panel{{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:14px 18px;box-shadow:0 1px 3px #00000006;display:inline-block;vertical-align:top;margin-right:10px;width:auto;min-width:300px;border-left:3px solid #d1d9e6}}.panel{{margin-bottom:10px;border-left-color:#bfd4f0}}.stat span,.mini-stats span{{display:block;color:#64748b;font-size:12px;font-weight:500}}.stat b{{font-size:22px;color:#0f172a}}.mini-stats{{display:grid;grid-template-columns:repeat(5,minmax(100px,1fr));gap:8px;margin:8px 0 10px}}.mini-stats>div{{background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px}}.mini-stats b{{font-size:17px;color:#0f172a}}table{{width:auto;border-collapse:separate;border-spacing:0;font-size:14px}}th,td{{text-align:left;border-bottom:1px solid #e2e8f0;padding:8px 10px;vertical-align:top;white-space:nowrap}}th{{color:#64748b;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.04em;background:#f8fafc;position:sticky;top:0;z-index:1}}td b{{display:block;font-weight:600}}td a{{font-weight:600}}.num{{text-align:center;font-weight:700;white-space:nowrap}}details summary{{cursor:pointer;color:#2563eb;font-weight:700;font-size:14px;margin-bottom:4px}}.tablebox{{display:inline-block;overflow:auto;border-radius:8px;border:1px solid #e2e8f0;background:#fff}}.unigrid{{display:grid;grid-template-columns:repeat(6,minmax(110px,1fr));gap:8px}}.unigrid>div{{background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px}}.unigrid span{{display:block;color:#64748b;font-size:12px;font-weight:500}}.unigrid b{{font-size:17px;color:#0f172a}}@media(max-width:900px){{.topgrid,.mini-stats,.unigrid{{grid-template-columns:1fr 1fr}}table{{min-width:auto}}.wrap{{padding:12px}}}}
